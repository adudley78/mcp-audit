...
- **SAST rule pack** — 69 Semgrep rules (36 Python, 33 TypeScript) across 6 categories for MCP server source code
...
1,731 tests validate detection accuracy and guard against regressions.
...
uv run pytest                        # Run all 1,731 tests
