...
- `rules/community/` — 12 bundled community detection rules (COMM-001 through COMM-012); ship in both pip wheel and PyInstaller binary; run for ALL users; see `docs/writing-rules.md`
